...
import getDependencies, {type PackageJson, type Dependency} from './index.js'
...
expectNotType<'dependencies'>(
  packageJson.devDependencies.get('package-name')!.type,
)
...
expectType<PackageJson>(getDependencies(`/path/to/directory/package.json`))
